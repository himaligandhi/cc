...
<body id="page-top" class="politics_version">
    ...
    <div class="container text-center">
      <img src="images/CaseStudy2.jpg" alt="casestudy" style="width: 100%;"/>
      <div class="centered">
       <h1 style="color:white;margin-top: 50px;margin-bottom: 30px;text-align: center;"><u>CASE STUDIES</u></h1></div>
      <!-- <h4 style="text-align: left; margin-top:150px;"> <a href="casestudy1.php" style="color:#8E0414;">$6,250,000 Restructuring A Distressed Development Project</a></h4> -->
       </div>  
...
<a href="casestudy1.php" style="float:right; margin-top:20px;border: 1px solid #8E0414; ">Read More</a> -->
</div>
