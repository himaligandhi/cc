<!--Navigation Start-->
 <nav class="navbar navbar-expand-lg navbar-dark" style="margin-bottom: 15px;">
   ...
   <a class="navbar-brand js-scroll-trigger" href="about.php">
      ...
      <a href="cred.php" class="sim-btn hvr-bounce-to-top" style="font-size: 1.5em;margin-right:30px;"> FINANCE APPLICATION: APPLY NOW</a>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark" style="margin-bottom: 0px;border-top:0.5px solid #44444C; border-bottom: 0.5px solid #44444C;background-color: #ececed;">
   <!-- <div class="container-fluid" style="border-top:0.5px solid #44444C; border-bottom: 0.5px solid #44444C;background-color: #ececed;"> -->
      ...
      <div class="collapse navbar-collapse navbar-collapse justify-content-md-center" id="mainNav">
         ...
         <li class="nav-item">
              ...
              <a href="insights.php" class="nav-link js-scroll-trigger dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">INSIGHTS <span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li><a href="blog.php" class="nav-link js-scroll-trigger">BLOGS</a></li>
                <li><a href="socialmedia.php" class="nav-link js-scroll-trigger">BUSINESS LOAN GUIDE</a></li>
                <li><a href="casestudy.php" class="nav-link js-scroll-trigger">CASE STUDIES</a></li>
</ul>
                    <li class="nav-item">
